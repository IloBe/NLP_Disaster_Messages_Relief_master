...
def clean_data(df):
	...
	# some messages are not labelled properly:
	# some should have 'child_alone' category value 1
	# create a new dataframe out of the new text file including a few sentences created with the dataset messages
